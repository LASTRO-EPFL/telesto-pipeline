"""
MOSAIC_OF_IMAGES2_other_method : from 4 images that superpose partly, creates a fifth,
bigger, image that is a combination of the previous ones. Same idea that Mosaic_of_
images2, but this time we align image 2 on image 1, then image 3 on image 1, and
image 4 on image 1, and finally we group every images together.
Remind: In Mosaic_of_images2, 2 is align on 1, then 3 is align with the aligned image
of 1 and 2. Finally image 4 is aligned with the aligned image of 1, 2 and 3.
...
def big_image(image, place):
    """Add pixels set to defaults arround initial image
...
def alignment(image_align, target, name):
    """ Align 2 images at a time.

    Return the combination of image_align, which is the alignment of
    an image and another one, and target image. Add target image on
    align image.

    Args:
        image_align(array-like): A numpy array of the image, which has
            been previously aligned on target image.
    ...
    Returns:
        image_combined : The new image, combination of the image_align and
            target image.
    ...
    image_combined = image_align

    name = 'image_align' + name
    save_image(image_combined, name)
...
image_align1_2 = aa.register(image_top_left, image_top_right)
image_align1_3 = aa.register(image_bottom_left, image_top_right)
image_align1_4 = aa.register(image_bottom_right, image_top_right)

image1_2 = alignment(image_align1_2, image_top_right, '1_2')
image1_2_3 = alignment(image_align1_3, image1_2, '1_2_3')
image1_2_3_4 = alignment(image_align1_4, image1_2_3, '1_2_3_4')

N = image1_2_3_4.shape
...
image_cut_intermediate = cut_image(image1_2_3_4)  # not necessary
